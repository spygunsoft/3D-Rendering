...
#define	GZ_TOON		3	/* interpolate normals */

//HW7
#define GZ_MDEFAULT	0	/* do flat shading with GZ_RBG_COLOR */
#define	GZ_MSIMPLETOON		1	/* interpolate vertex color */
#define	GZ_MLINE		2	/* interpolate vertex color */
#define GZ_MPENCEL	3

#define GZ_COMBINE_OVERRIDE	0
#define GZ_COMBINE_MASKOVERRIDE 1
#define GZ_COMBINE_REVERSEMASKOVERRIDE 2
